...
function setupSidebarNav() {
    const sidebar = document.querySelector('.sidebar');
    if (!sidebar) {
        console.error('Sidebar not found! Make sure you added the sidebar HTML.');
        return;
    }
    ...
    desktopTabs.forEach(tab => {
        ...
        sidebarBtn.className = 'tab-btn';
        sidebarBtn.dataset.tab = tab.dataset.tab;
        sidebarBtn.textContent = tab.textContent;
        ...
        sidebarBtn.addEventListener('click', () => {
            ...
            // Update active states for all tab buttons (desktop and sidebar)
    ...
    console.log('Sidebar navigation setup complete with', desktopTabs.length, 'tabs');
}
